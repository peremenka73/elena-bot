...
# Реквизиты для оплаты консультации. Карта и телефон в <code>...</code> — в Telegram
# такой текст можно скопировать одним тапом (сообщение отправляется в HTML-разметке).
PAYMENT_REQUISITES = (
    "Карта: <code>2200 1502 2140 2974</code>\n"
    "Получатель: Семенова Елена Петровна\n"
    "Телефон (СБП): <code>+7 937 275-32-06</code>"
)
