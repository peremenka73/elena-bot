...
GUIDES = {
    ...
    "reboot_instruction": {
        "title": "Инструкция по перезагрузке",
        "file": "Instrukciya po perezagruzke.pdf",
        "caption": (
            "Иногда телу и психике нужна настоящая перезагрузка. Внутри — практическая "
            "инструкция, как аккуратно «обнулиться» и вернуть себе ресурс, шаг за шагом."
        ),
    },
}
